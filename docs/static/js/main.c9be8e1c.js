/*! For license information please see main.c9be8e1c.js.LICENSE.txt */
;(() => {
  'use strict'
  var e = {
      597: (e, n) => {
        ...
        Object.defineProperty(n, '__esModule', { value: !0 }),
          ...
          (n.batchPrograms = function (e, n) {
            const l = [],
              a = []
            for (const t of e) l.push(t.init[0]), a.push(t.init[1])
            return {
              init: [
                l,
                r(
                  a.flatMap((e, n) =>
                    e ? [t(e, (e) => ({ index: n, data: e }))] : []
                  )
                ),
              ],
              update: function (n, r) {
                const { index: l } = n,
                  a = e[l].update(n.data, r[l]),
                  [o, u] = a,
                  i = r.slice(0)
                return (
                  (i[l] = o),
                  [i, u ? t(u, (e) => ({ index: l, data: e })) : void 0]
                )
              },
              view: function (t, r) {
                const l = e.map(
                  (e, n) => () => e.view(t[n], (e) => r({ index: n, data: e }))
                )
                return n(l)
              },
              done: function (n) {
      ...
      970: (e, n) => {
        ;(n.G = void 0),
          (n.G = function (e) {
            const { init: n, update: t, view: r, done: l } = e
            let a,
              o = !0
            function u(e) {
              o && i(t(e, a))
      ...
      97: (e, n, t) => {
        ...
        function a(e, n) {
          const t = [...Object.keys(e), ...Object.keys(n)],
            a = {},
            o = [],
            u = {}
          for (const r of t) {
            ...
            if (i && !s) o.push(t)
              ...
              const { effect: e, cancel: n } = s()
              o.push(e), (u[r] = n)
            } else i && t && (u[r] = t)
          }
          return { effect: (0, r.batchEffects)(o), cancelMap: u }
        }
        ;(n.S3 = function (e, n) {
          return { effect: (0, r.mapEffect)(e.effect, n), cancel: e.cancel }
        }),
          (n.Db = function (e) {
            const [n, t] = e.init,
              { effect: l, cancelMap: o } = a({}, e.subscriptions(n))
            return {
              init: [
                { cancelMap: o, programModel: n },
                (0, r.batchEffects)([t, l]),
              ],
              update: function (n, t) {
                const [l, o] = e.update(n, t.programModel),
                  { effect: u, cancelMap: i } = a(
                    t.cancelMap,
                    e.subscriptions(l)
                  )
                return [
                  { cancelMap: i, programModel: l },
                  (0, r.batchEffects)([o, u]),
                ]
              },
              done: function (n) {
                a(n.cancelMap, {}).effect(() => {}),
      ...
      463: (e, n, t) => {
        ...
        function Kn(e, n, t, r) {
          if (Hn) {
            var l = Xn(e, n, t, r)
            if (null === l) Br(e, n, r, Yn, t), Dn(e, r)
            else if (
              (function (e, n, t, r, l) {
                switch (n) {
                  case 'focusin':
        ...
        function Vr(e) {
          if (!e[Wr]) {
            ...
            null === n || n[Wr] || ((n[Wr] = !0), Ar('selectionchange', !1, n))
          }
        }
        function $r(e, n, t, r) {
          switch (Gn(n)) {
        ...
        function Kr(e, n, t, r, l) {
          for (var a = n._reactName, o = []; null !== t && t !== r; ) {
            ...
            5 === u.tag &&
              ...
              ((u = s),
              l
                ? null != (i = Le(t, a)) && o.unshift(Hr(t, i, u))
                : l || (null != (i = Le(t, a)) && o.push(Hr(t, i, u)))),
              (t = t.return)
          }
        ...
        function na(e) {
          for (; e === Hl; )
            (Hl = $l[--Bl]), ($l[Bl] = null), (Ql = $l[--Bl]), ($l[Bl] = null)
          for (; e === Yl; )
            (Yl = ql[--Kl]),
              (ql[Kl] = null),
              (Gl = ql[--Kl]),
        ...
        function Ha(e, n, t, r) {
          var l = e.stateNode
          ;(l.props = t), (l.state = e.memoizedState), (l.refs = ja), Ma(e)
          var a = n.contextType
          'object' === typeof a && null !== a
            ? (l.context = Ca(a))
            : ((a = Ll(n) ? Tl : Nl.current), (l.context = Ml(e, a))),
          ...
          if ((ku(e, n, r.children, t), 0 !== (2 & (r = uo.current))))
            ...
            if (null !== e && 0 !== (128 & e.flags))
              e: for (e = n.child; null !== e; ) {
                if (13 === e.tag) null !== e.memoizedState && Wu(e, t, n)
                else if (19 === e.tag) Wu(e, t, n)
              ...
              switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
                ...
                case 3:
                  if (
                    ...
                    e.timeoutHandle = rl(Ss.bind(null, e, Wi, Bi), n)
                    break
                  }
                  Ss(e, Wi, Bi)
                  break
                case 4:
                  ...
                  if (
                    ...
                    e.timeoutHandle = rl(Ss.bind(null, e, Wi, Bi), r)
                    break
                  }
                  Ss(e, Wi, Bi)
                  break
        ...
        function os(e, n) {
          ...
          return (
            ...
            2 !== (e = gs(e, n)) && ((n = Wi), (Wi = t), null !== n && us(n)),
            e
          )
        }
        function us(e) {
        ...
        function ps(e, n) {
          ...
          if ((-1 !== t && ((e.timeoutHandle = -1), ll(t)), null !== Mi))
        ...
        function gs(e, n) {
          ...
          if ((ka(), (zi = t), (_i.current = r), null !== Mi))
            throw Error(a(261))
        ...
        function ks(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              if (null !== (t = Ku(t, n, Ri))) return void (Mi = t)
            } else {
              if (null !== (t = Yu(t, n)))
                return (t.flags &= 32767), void (Mi = t)
              if (null === e) return (Oi = 6), void (Mi = null)
        ...
        function $s(e, n, t, r, l, a, o, u, i) {
          return (
            ((e = Ws(t, r, !0, e, 0, a, 0, u, i)).context = Vs(null)),
            (t = e.current),
              ...
              e: {
                ...
                if (((r = u.element), o.isDehydrated)) {
                  if (
                    ...
                    n = Mu(e, n, r, t, (l = cu(Error(a(423)), n)))
                    break e
                  }
                  if (r !== l) {
                    n = Mu(e, n, r, t, (l = cu(Error(a(424)), n)))
                    break e
                  }
                  for (
  ...
  ;(() => {
    ...
    function u(e) {
      const { wheelCanvas: n } = e,
        t = n.current
      if (!t) return
      const { width: r, height: l } = e.windowSize,
        a = Math.min(r, l),
        o = Math.floor(r < l ? Math.min(0.75 * a, l) : Math.min(0.75 * a, r))
      t.width !== 2 * o &&
        (function (e, n) {
          ...
          for (; l < 360; ) {
            const e = (o + 3 - 1) % 3
            a[o] < 255
              ? (a[o] = a[o] + u > 255 ? 255 : a[o] + u)
              : a[e] > 0
              ? (a[e] = a[e] > u ? a[e] - u : 0)
              : a[o] >= 255 && ((a[o] = 255), (o = (o + 1) % 3))
            const n = 'rgb('.concat(a.map((e) => Math.floor(e)).join(','), ')'),
              s = t.createRadialGradient(i, i, 0, i, i, i)
            s.addColorStop(0, r),
              s.addColorStop(1, n),
              (t.fillStyle = s),
    ...
    function s(e, n) {
      ...
      let r = 0
      for (; r++ < 10; ) {
        const r = Math.floor(Math.random() * e.width),
          l = Math.floor(Math.random() * e.height),
          a = t.getImageData(r, l, 1, 1).data,
          o = [a[0], a[1], a[2]]
        if (
          !o.every((e) => e > 232) &&
          !o.every((e) => 0 === e) &&
    ...
    const f = (0, r.Db)({
            ...
            return [
              {
                ...
                levelStart: Date.now(),
                wallProgress: 0,
                nextWallColor: n.wheelCanvas.current
                  ? s(n.wheelCanvas.current, n.previousWallColor)
                  : a,
              },
            ]
          case 'open_about':
            return [{ ...n, scene: 'about' }]
          case 'return_home':
            return [
              { ...o[0], windowSize: n.windowSize, wheelCanvas: n.wheelCanvas },
            ]
          case 'window_size': {
            const t = { ...n, windowSize: e.size }
            return u(t), [t]
          }
          case 'draw_tick':
            switch ((u(n), n.scene)) {
              case 'home': {
                const e = n.wheelRotation >= 359 ? 0 : n.wheelRotation + 0.25
                return [{ ...n, wheelRotation: e }]
              }
              case 'game': {
                if (1 === n.wallProgress)
                  return [
                    {
                      ...n,
                      scene: 'game-over',
                      previousWallColor: n.nextWallColor,
                    },
                  ]
                const e = 5e3 - (n.score > 50 ? n.score : 50 * n.score),
                  t = Math.max(Math.min((Date.now() - n.levelStart) / e, 1), 0)
                return [{ ...n, wallProgress: t }]
              }
              default:
                return [n]
            }
          case 'wheel_click': {
            const { wheelCanvas: t } = n,
              r = t.current
            if (!r) return [n]
            const l = r.width / 4,
              [a, o] = (function (e, n, t, r, l) {
                const a = (Math.PI / 180) * l,
                  o = Math.cos(a),
                  u = Math.sin(a)
                return [
                  o * (t - e) + u * (r - n) + e,
              ...
              })(l, l, e.x, e.y, n.wheelRotation),
              u = (function (e, n, t) {
                const r = e.getContext('2d', { willReadFrequently: !0 })
                if (!r) return
                const l = r.getImageData(n, t, 1, 1).data,
                  a = [l[0], l[1], l[2]]
                return a.every((e) => 0 === e) ? void 0 : a
              })(r, 2 * a, 2 * o)
            if (!u) return [n]
            if (p(u, n.nextWallColor) > i) return [n]
            const c = Math.max(0, Math.min(360, 360 * Math.random()))
            return [
              {
                ...n,
                score: n.score + 1,
                previousWallColor: n.nextWallColor,
                nextWallColor: s(r, n.nextWallColor),
                wallProgress: 0,
                levelStart: Date.now(),
                wheelRotation: c,
              },
      ...
      view: function (e, n) {
        ...
        switch (e.scene) {
          case 'about':
            ;(t = 'About Maid Cafe Omurice Simulator'),
              (r = (0, l.jsx)('button', {
                onClick: () => n({ type: 'return_home' }),
                children: 'Back to game',
              }))
            break
          case 'game':
            ;(t = 'Match '.concat(e.score + 1)),
              (r = ''.concat((100 * (1 - e.wallProgress)).toFixed(0), '%'))
            break
          case 'game-over':
            ;(t = (0, l.jsx)('span', {
              onClick: () => n({ type: 'return_home' }),
              ...
              (r = 'Final score: '.concat(e.score))
            break
          case 'home':
            ;(t = 'Maid Cafe Omurice Simulator'),
              (r = (0, l.jsx)('button', {
                onClick: () => n({ type: 'open_about' }),
        ...
        return (0, l.jsxs)('div', {
          ...
          children: [
            ...
            (0, l.jsx)('div', {
              className: 'footer',
              children: (0, l.jsx)('h1', { children: r }),
            }),
            (0, l.jsx)('div', {
              onClick:
                'game' === e.scene
              ...
              children: (0, l.jsx)('canvas', {
                id: 'canvas',
                style: {
                  opacity: 'about' === e.scene ? 0.1 : void 0,
                  rotate: ''.concat(e.wheelRotation, 'deg'),
                  transition:
                    'game' === e.scene
            ...
            'about' === e.scene &&
              (0, l.jsxs)('div', {
                ...
                children: [
                  (0, l.jsx)('p', {
                    children:
                      'Become one with the color wheel as you race to match the incoming colors.',
                  }),
                  (0, l.jsxs)('p', {
                    children: [
                      'Made by ',
            ...
            ('home' === e.scene || 'game-over' === e.scene) &&
              (0, l.jsx)('button', {
                className: 'play-button',
                onClick: () => n({ type: 'start_game' }),
                children: (0, l.jsx)('div', { className: 'play-button--icon' }),
              }),
            (0, l.jsx)('div', {
              className: 'old-color-wall',
              style: { backgroundColor: c(e.previousWallColor) },
            }),
            (0, l.jsx)('div', {
              className: 'new-color-wall',
              style: {
                backgroundColor: c(e.nextWallColor),
                width: ''.concat(100 * e.wallProgress, '%'),
              },
              children:
                'game' === e.scene &&
                0 === e.score &&
                (0, l.jsxs)(l.Fragment, {
                  children: [
                    (0, l.jsx)('div', {
                      className: 'header header--static',
                      children: (0, l.jsx)('h1', { children: '\xa0\xa0' }),
                    }),
                    (0, l.jsx)('p', {
                      className: 'tutorial-indicator',
                      children: 'Match this color \u27a1',
                    }),
                  ],
                }),
            }),
          ...
          tick: () =>
            (0, r.S3)(
              (function () {
                ...
                return {
                  effect: (t) => {
                    e = requestAnimationFrame(function r() {
                      const l = Date.now()
                      t(l - n), (n = l), (e = requestAnimationFrame(r))
                    })
                  },
                  cancel() {
            ...
            (0, r.S3)(
              (function () {
                ...
                return {
                  ...
                  cancel() {
                    e && window.removeEventListener('resize', e)
                  },
                }
              })(),
              (e) => ({ type: 'window_size', size: e })
            ),
        }
      },
    })
    ...
    function p(e, n) {
      let t = h(e),
        ...
        a = t[1] - r[1],
        o = t[2] - r[2],
        u = Math.sqrt(t[1] * t[1] + t[2] * t[2]),
        i = u - Math.sqrt(r[1] * r[1] + r[2] * r[2]),
        s = a * a + o * o - i * i
      s = s < 0 ? 0 : Math.sqrt(s)
      let c = l / 1,
        f = i / (1 + 0.045 * u),
    ...
    function h(e) {
      ...
      return (
        ...
        (n = (0.4124 * l + 0.3576 * a + 0.1805 * o) / 0.95047),
        (t = (0.2126 * l + 0.7152 * a + 0.0722 * o) / 1),
        (r = (0.0193 * l + 0.1192 * a + 0.9505 * o) / 1.08883),
        (n = n > 0.008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116),
        (t = t > 0.008856 ? Math.pow(t, 1 / 3) : 7.787 * t + 16 / 116),
        (r = r > 0.008856 ? Math.pow(r, 1 / 3) : 7.787 * r + 16 / 116),
        [116 * t - 16, 500 * (n - t), 200 * (t - r)]
      )
    }
    var m = t(970)
    const v = n.createRoot(document.getElementById('root')),
      g =
        ((y = () => f),
        class extends e.Component {
          constructor() {
            super(...arguments),
              ...
              (this._killProgram = void 0)
          }
          componentDidMount() {
            const e = y(this.props)
            ;(this._view = e.view),
              (this._killProgram = (0, m.G)({
                ...e,
                view: (e, n) => {
                  ;(this._dispatch = n), this.setState(() => ({ state: e }))
                },
              }))
          }
    ...
    var y
    v.render((0, l.jsx)(e.StrictMode, { children: (0, l.jsx)(g, {}) }))
  })()
})()
//# sourceMappingURL=main.c9be8e1c.js.map
